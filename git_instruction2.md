...
<br><br>
* **git&emsp;merge&emsp;branchone&emsp;branchtwo**&emsp;-&emsp;_Команда позволяет `"сливать"` (объединять) ветки (в данном случае ветки __branchone__ и __branchtwo__)._
* **git branch**&emsp;**-d**&emsp;**mergedbranch**&emsp;-&emsp;_Команда удаления ветки (в данном случае ее имя - **mergedbranch**). Используется обычно, когда ветки удачнно слиты, и остались ненужные.